...
> [!NOTE]
> This fork focuses solely on the python version of rtl_433_stats, for the C version please see the [Original Repository](https://github.com/hdtodd/rtl_433_stats).
